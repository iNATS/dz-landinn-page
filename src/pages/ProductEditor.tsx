        ...
        {steps.map((s, i) => (
          <div key={s.key} className="flex flex-col items-center gap-1 flex-1 relative">
            <div className={cn(
              ...
              step === s.key ? "bg-emerald-500 text-white" : "bg-white text-black/20 border border-black/[0.05]"
            )}>
              <s.icon size={14} />
            </div>
            <span className={cn("text-[9px] font-black uppercase tracking-widest mt-1", step === s.key ? "text-emerald-600" : "text-black/20")}>
              {s.label}
            </span>
          </div>
        ))}
      ...
      <main className="px-6 mt-6">
        <AnimatePresence mode="wait">
          {step === "basic" && (
            ...
            >
              <GlassCard className="space-y-4 border-black/[0.05]">
                <h2 className="text-sm font-bold text-emerald-600 mb-4 flex items-center">
                  <span className="w-2 h-2 rounded-full bg-emerald-500 ml-2"></span> معلومات المنتج
                </h2>
                <div>
                  ...
                  <input 
                    ...
                    className="w-full h-12 bg-white border border-black/[0.05] rounded-xl px-4 outline-none font-bold text-[#1C1C1E] focus:border-emerald-500/50"
                  />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full h-12 bg-white border border-black/[0.05] rounded-xl px-4 outline-none font-bold text-emerald-600 focus:border-emerald-500/50"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white border border-black/[0.05] rounded-xl p-4 outline-none font-medium text-[#1C1C1E] focus:border-emerald-500/50"
                  />
                </div>
              </GlassCard>
          ...
          {step === "appearance" && (
            ...
            >
              <GlassCard className="space-y-6 border-black/[0.05]">
                <h2 className="text-sm font-bold text-emerald-600">المظهر وتجربة المستخدم</h2>
                <div>
                  ...
                  <div className="flex items-center gap-2 overflow-x-auto pb-2 no-scrollbar">
                    {["#10B981", "#3B82F6", "#EF4444", "#F59E0B", "#8B5CF6", "#EC4899", "#22D3EE", "#1C1C1E", "#4B5563"].map(color => (
                        <button
                          key={color}
          ...
          {step === "media" && (
            ...
            >
              <GlassCard className="space-y-4 border-black/[0.05]">
                <h2 className="text-sm font-bold text-emerald-600">معرض الصور</h2>
                <div className="grid grid-cols-2 gap-4">
              ...
              <GlassCard className="space-y-6 border-black/[0.05]">
                ...
                <div className="bg-[#F2F2F7] rounded-2xl p-6 border border-black/[0.05]">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-2xl font-black text-emerald-600 tracking-tighter">2,000 دج</span>
                  </div>
