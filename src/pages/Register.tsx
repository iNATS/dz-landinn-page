...
import { UserPlus, Mail, Lock, AlertCircle, Building } from "lucide-react";
...
export default function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("تم التسجيل! يرجى التحقق من بريدك الإلكتروني.");
      navigate("/login");
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-[#F2F2F7] flex flex-col justify-center px-6 safe-top py-10" dir="rtl">
      ...
      >
        <div className="text-center">
          <h1 className="text-4xl font-black mb-2 tracking-tight">ابدأ اليوم</h1>
          <p className="text-black/40 font-bold uppercase tracking-widest text-xs">أنشئ حسابك ومجرك الإلكتروني في ثوانٍ</p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <Building className="absolute right-4 top-1/2 -translate-y-1/2 text-black/20" size={18} />
                  <input
                    type="text"
                    required
                    value={companyName}
